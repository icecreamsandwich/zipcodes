Preface
================
I forked this npm package from `https://github.com/davglass/zipcodes` and made modifications to suite my requirements. Thanks @https://github.com/davglass/ for contributing to opensource. 👍
